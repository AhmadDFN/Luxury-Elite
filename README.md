Markdown
# 🎮 Luxury Elite - Internal Esports Team Management Platform

An elegant, scalable, and modern internal management platform built specifically for the esports organization **Luxury Elite**. This platform bridges the gap between internal team operations (scrims, rosters, VODs) and public presentation.
...
This project leverages a cutting-edge monolithic architecture with a decoupled frontend feel:

* **Backend:** Laravel (Robust, secure, and highly scalable)
* **Frontend Adapter:** Inertia.js (Seamless SPA experience without building an isolated API)
* **Frontend UI:** Svelte (Ultra-fast, reactive, and minimal bundle size)
* **Styling:** Tailwind CSS (Clean and modern utility-first design)
* **Database:** SQLite / MySQL (Optimized with structured pivot tracking)
...
Pivot Table Implementation: Used for handling multiple game roles and vehicle specializations dynamically without hardcoding.
